...
public class LogElement {
     ...
     *
     * @param time Время получения запроса
     * @param ip   IP-адрес пользователя в формате IPv6
     * @param text Исходный пользовательский текст
     * @param from Исходный язык пользовательского текста
     * @param to   Желаемый язык переведенного текста
     */
